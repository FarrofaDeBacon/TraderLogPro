...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
    ...
    <Card class="border shadow-md bg-card/60 backdrop-blur-xl border-l-4 border-l-emerald-500 overflow-hidden">
        <CardContent class="p-4 flex flex-col items-center text-center justify-center">
            ...
            <h3 class="text-xs font-black uppercase tracking-widest text-muted-foreground mb-1">{$t('strategy.gann.mastery')}</h3>
            <div class={`text-3xl font-black ${getMasteryColor(gannMastery)}`}>
                {gannMastery.toFixed(0)}%
            </div>
            <p class="text-[9px] text-muted-foreground mt-1 uppercase font-bold">{$t('strategy.gann.mathematicalConfluence')}</p>
        </CardContent>
    </Card>
    ...
    <Card class="border shadow-md bg-card/60 backdrop-blur-xl overflow-hidden">
        <CardContent class="p-4 space-y-3">
            <div class="flex justify-between items-start">
                <div>
                    <h3 class="text-xs font-bold text-muted-foreground uppercase tracking-widest">{$t('strategy.gann.alignment')}</h3>
                    <p class="text-[9px] text-muted-foreground">{$t('strategy.gann.alignmentDesc')}</p>
                </div>
            ...
            <div class="space-y-1">
                <div class="flex justify-between items-end">
                    ...
                    <span class="text-[9px] font-bold text-muted-foreground uppercase">{$t('strategy.gann.accuracy')}</span>
                </div>
    ...
    <Card class="border shadow-md bg-card/60 backdrop-blur-xl overflow-hidden">
        <CardContent class="p-4 space-y-3">
            <div class="flex justify-between items-start">
                <div>
                    <h3 class="text-xs font-bold text-muted-foreground uppercase tracking-widest">{$t('strategy.gann.cycleWatch')}</h3>
                    <p class="text-[9px] text-muted-foreground">{$t('strategy.gann.cycleWatchDesc')}</p>
                </div>
            ...
            <div class="space-y-1">
                <div class="flex justify-between items-end">
                    ...
                    <span class="text-[9px] font-bold text-muted-foreground uppercase">{$t('strategy.gann.success')}</span>
                </div>
    ...
    <Card class="border shadow-md bg-card/60 backdrop-blur-xl overflow-hidden">
        <CardContent class="p-4 space-y-3">
            <div class="flex justify-between items-start">
                <div>
                    <h3 class="text-xs font-bold text-muted-foreground uppercase tracking-widest">{$t('strategy.gann.angleScore')}</h3>
                    <p class="text-[9px] text-muted-foreground">{$t('strategy.gann.geometricPrecision')}</p>
                </div>
            ...
            <div class="space-y-1">
                <div class="flex justify-between items-end">
                    ...
                    <span class="text-[9px] font-bold text-muted-foreground uppercase">{$t('strategy.gann.adherence')}</span>
                </div>
...
<Card class="mt-4 border shadow-md bg-card/60 backdrop-blur-xl border-t-2 border-t-emerald-500/50">
    <CardContent class="p-6">
        <div class="flex items-center gap-3 mb-6">
            ...
            <div>
                <h3 class="text-base font-bold tracking-tight">{$t('strategy.gann.analyticalConfluence')}</h3>
                <p class="text-xs text-muted-foreground">{$t('strategy.gann.confluenceDesc')}</p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="space-y-4">
                <div class="flex items-center gap-2">
                    ...
                    <h4 class="text-xs font-bold uppercase tracking-wider">{$t('strategy.gann.vibrationLaw')}</h4>
                </div>
                <p class="text-xs text-muted-foreground leading-relaxed">
                    {$t('strategy.gann.vibrationLawDesc')}
                </p>
            </div>
            ...
            <div class="space-y-4 border-l border-r border-border/50 px-8">
                <div class="flex items-center gap-2">
                    ...
                    <h4 class="text-xs font-bold uppercase tracking-wider">{$t('strategy.gann.timeLaw')}</h4>
                </div>
                <p class="text-xs text-muted-foreground leading-relaxed">
                    {$t('strategy.gann.timeLawDesc')}
                </p>
            </div>
            ...
            <div class="space-y-4">
                <div class="flex items-center gap-2">
                    ...
                    <h4 class="text-xs font-bold uppercase tracking-wider">{$t('strategy.gann.geometryLaw')}</h4>
                </div>
                <p class="text-xs text-muted-foreground leading-relaxed">
                    {$t('strategy.gann.geometryLawDesc')}
                </p>
            </div>
        </div>
    </CardContent>
